...
package com.veken.expandablelistview.wheelview;
...
import com.veken.expandablelistview.R;
import com.veken.expandablelistview.wheelview.adapter.WheelViewAdapter;
...
//			0xcfE9E9E9, 0x3fE9E9E9 };
    ...
    //百分之70透明度的白色遮盖
    private int[] SHADOWS_COLORS = new int[]{0xe6ffffff,
            0xccffffff, 0xb3ffffff};
    // Wheel Values
...
//	private int wheelBackground = R.drawable.wheel_bg;
    ...
    private void drawShadows(Canvas canvas) {
		/*/ Modified by liuqi 2015-09-30  2*getItemHeight 其中2的数量决定于当前视图选中项的上面和下面各显示多少项决定
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.main_text_noselected));
        // 设置线宽
        paint.setStrokeWidth((float) 1);
        // 绘制上边直线
        canvas.drawLine(0, center - offset, getWidth(), center - offset, paint);
        // 绘制下边直线 -1 是为了腾出1px的位置给线条，要不然下面的线要比上面得线条要浅
